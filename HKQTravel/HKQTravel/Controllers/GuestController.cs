...
namespace HQKTravel.Controllers
{
    public class GuestController : Controller
    {
        ...
        public ActionResult changePassword(FormCollection collection, string userName)
        {
            ...
            var check_user = Session["user_account"].ToString();
            var check_password = data.user_accounts.FirstOrDefault(model => model.user_password == pass);
            ...
            else
            {
                ...
                user_Account.user_password = confirm_pass;
                data.user_accounts.InsertOnSubmit(user_Account);
                data.SubmitChanges();
            }
